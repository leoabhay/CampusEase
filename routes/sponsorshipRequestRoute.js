...
const Form = require('../models/sponsorshipRequestModel');
const verifyToken = require('../middlewares/middleware');
const Signup = require('../models/userModel');

// Create post sponsorship request
...
// Read one sponsorship request by ID
...
// Read one sponsorship request by email
...
// Read sponsorship requests by role (sponsor)
...
// Update sponsorship request by ID (for admin to accept/reject)
...
// Update sponsorship request by ID (for user to update their request)
...
// Delete sponsorship request by ID
